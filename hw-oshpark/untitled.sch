...
<layer number="51" name="tDocu" color="14" fill="4" visible="no" active="no"/>
<layer number="52" name="bDocu" color="14" fill="5" visible="no" active="no"/>
...
<package name="DIP-8">
<pad name="1" x="-3.94" y="3.81" drill="0.6" diameter="0.9" shape="square" first="yes"/>
<rectangle x1="-3.94" y1="3.09" x2="-3.24" y2="4.53" layer="51"/>
<pad name="2" x="-3.94" y="1.27" drill="0.6" diameter="0.9"/>
<rectangle x1="-3.94" y1="0.55" x2="-3.24" y2="1.99" layer="51"/>
<pad name="3" x="-3.94" y="-1.27" drill="0.6" diameter="0.9"/>
<rectangle x1="-3.94" y1="-1.99" x2="-3.24" y2="-0.55" layer="51"/>
<pad name="4" x="-3.94" y="-3.81" drill="0.6" diameter="0.9"/>
<rectangle x1="-3.94" y1="-4.53" x2="-3.24" y2="-3.09" layer="51"/>
<pad name="5" x="3.94" y="-3.81" drill="0.6" diameter="0.9"/>
<rectangle x1="3.24" y1="-4.53" x2="3.94" y2="-3.09" layer="51"/>
<pad name="6" x="3.94" y="-1.27" drill="0.6" diameter="0.9"/>
<rectangle x1="3.24" y1="-1.99" x2="3.94" y2="-0.55" layer="51"/>
<pad name="7" x="3.94" y="1.27" drill="0.6" diameter="0.9"/>
<rectangle x1="3.24" y1="0.55" x2="3.94" y2="1.99" layer="51"/>
<pad name="8" x="3.94" y="3.81" drill="0.6" diameter="0.9"/>
<rectangle x1="3.24" y1="3.09" x2="3.94" y2="4.53" layer="51"/>
<wire x1="-0.5" y1="4.7984" x2="0.5" y2="4.7984" width="0.2032" layer="21" curve="180"/>
<wire x1="-3.1384" y1="-4.7984" x2="3.1384" y2="-4.7984" width="0.2032" layer="21"/>
<wire x1="3.1384" y1="-4.7984" x2="3.1384" y2="4.7984" width="0.2032" layer="21"/>
<wire x1="3.1384" y1="4.7984" x2="-3.1384" y2="4.7984" width="0.2032" layer="21"/>
<wire x1="-3.1384" y1="4.7984" x2="-3.1384" y2="-4.7984" width="0.2032" layer="21"/>
<text x="-2.67" y="5.21" size="0.8128" layer="25" font="vector">&gt;NAME</text>
<text x="-2.67" y="-5.845" size="0.8128" layer="27" font="vector">&gt;VALUE</text>
</package>
...
<text x="-5.715" y="-1.27" size="0.8128" layer="25" font="vector" rot="R90">&gt;NAME</text>
...
<description>Aka: D2PAK</description>
...
<text x="-2.667" y="-1.27" size="0.8128" layer="25" font="vector" rot="R90">&gt;NAME</text>
<text x="-1.905" y="-0.127" size="0.8128" layer="27" font="vector">&gt;VALUE</text>
...
<pin name="GP0" x="-15.24" y="2.54" length="short"/>
<pin name="GP1" x="-15.24" y="0" length="short"/>
<pin name="!RST!" x="-15.24" y="7.62" length="short" direction="in"/>
<pin name="URX" x="15.24" y="-7.62" length="short" direction="in" rot="R180"/>
<pin name="UTX" x="15.24" y="-5.08" length="short" direction="out" rot="R180"/>
<pin name="GP2" x="-15.24" y="-2.54" length="short"/>
<pin name="GP3" x="-15.24" y="-5.08" length="short"/>
<pin name="SDA" x="15.24" y="-2.54" length="short" rot="R180"/>
<pin name="SCL" x="15.24" y="0" length="short" direction="out" rot="R180"/>
<pin name="3V3" x="-2.54" y="12.7" length="short" direction="pwr" rot="R270"/>
...
<symbol name="LPC810">
<pin name="!RST!/PIO0_5" x="22.86" y="-10.16" length="short" rot="R180"/>
<pin name="PIO0_4/WAKEUP/!TRST!" x="22.86" y="-7.62" length="short" rot="R180"/>
<pin name="SWCLK/PIO0_3/TCK" x="22.86" y="-5.08" length="short" rot="R180"/>
<pin name="SWDIO/PIO0_2/TMS" x="22.86" y="-2.54" length="short" rot="R180"/>
<pin name="PIO0_1/ACMP_I2/CLKIN/TDI" x="22.86" y="0" length="short" rot="R180"/>
<pin name="VDD" x="-22.86" y="2.54" length="short" direction="pwr"/>
<pin name="VSS" x="-22.86" y="-10.16" length="short" direction="pwr"/>
<pin name="PIO0_0/ACMP_I1/TDO" x="22.86" y="2.54" length="short" rot="R180"/>
...
<pin name="IN" x="-12.7" y="5.08" visible="pin" length="short" direction="pwr"/>
...
<pin name="BP/NC" x="12.7" y="-5.08" visible="pin" length="short" direction="pas" rot="R180"/>
</symbol>
</symbols>
<devicesets>
<deviceset name="MCP2221" prefix="U">
<description>USB-to-UART/I2C serial converter</description>
<gates>
...
<connect gate="G$1" pin="3V3" pad="11"/>
...
<deviceset name="LPC810" prefix="U">
<description>ARM Cortex-M0+ MCU in DIP-8</description>
<gates>
<gate name="G$1" symbol="LPC810" x="0" y="0"/>
</gates>
<devices>
<device name="M021JN8" package="DIP-8">
<connects>
<connect gate="G$1" pin="!RST!/PIO0_5" pad="1"/>
<connect gate="G$1" pin="PIO0_0/ACMP_I1/TDO" pad="8"/>
<connect gate="G$1" pin="PIO0_1/ACMP_I2/CLKIN/TDI" pad="5"/>
<connect gate="G$1" pin="PIO0_4/WAKEUP/!TRST!" pad="2"/>
<connect gate="G$1" pin="SWCLK/PIO0_3/TCK" pad="3"/>
<connect gate="G$1" pin="SWDIO/PIO0_2/TMS" pad="4"/>
...
<description>Low drop fixed and adjustable positive voltage regulators</description>
<gates>
...
<device name="-V" package="TO-220L1">
<connects>
<connect gate="G$1" pin="GND" pad="1"/>
<connect gate="G$1" pin="IN" pad="3"/>
...
<device name="-D2MTR" package="SMD-220">
<connects>
<connect gate="G$1" pin="GND" pad="1"/>
<connect gate="G$1" pin="IN" pad="3"/>
<connect gate="G$1" pin="OUT" pad="2"/>
...
<deviceset name="LDO-SOT23-5" prefix="U" uservalue="yes">
<description>LDO regulators in SOT23-5 packages with standard pinout</description>
<gates>
<gate name="G$1" symbol="GENERIC-LDO-5PIN" x="0" y="0"/>
</gates>
<devices>
<device name="" package="SOT-23-5">
<connects>
<connect gate="G$1" pin="BP/NC" pad="4"/>
...
<parts>
<part name="U1" library="dword1511-ic" deviceset="MCP2221" device="SL"/>
<part name="U2" library="dword1511-ic" deviceset="LPC810" device="M021JN8"/>
<part name="C1" library="rcl" deviceset="C-US" device="C0805"/>
<part name="C2" library="rcl" deviceset="C-US" device="C0805"/>
<part name="F1" library="rcl" deviceset="R-US_" device="R0805"/>
<part name="J1" library="adafruit" deviceset="USB-A" device=""/>
<part name="U3" library="dword1511-ic" deviceset="LD1117-" device="-S" technology="33"/>
...
<part name="R1" library="rcl" deviceset="R-US_" device="R0805" value="1Meg"/>
...
<part name="D1" library="led" deviceset="LED" device="SML0805" value="LNK"/>
<part name="D2" library="led" deviceset="LED" device="SML0805" value="ACT"/>
...
<part name="U4" library="dword1511-ic" deviceset="LDO-SOT23-5" device=""/>
...
<instances>
<instance part="U1" gate="G$1" x="68.58" y="2.54"/>
<instance part="U2" gate="G$1" x="7.62" y="5.08"/>
<instance part="C1" gate="G$1" x="60.96" y="30.48"/>
<instance part="C2" gate="G$1" x="76.2" y="30.48"/>
<instance part="F1" gate="G$1" x="96.52" y="35.56"/>
<instance part="J1" gate="G$1" x="121.92" y="0" rot="MR0"/>
<instance part="U3" gate="G$1" x="22.86" y="35.56" rot="MR0"/>
...
<instance part="J2" gate="G$1" x="76.2" y="-33.02"/>
<instance part="GND10" gate="1" x="66.04" y="-38.1"/>
<instance part="D1" gate="G$1" x="58.42" y="60.96" rot="R270"/>
<instance part="D2" gate="G$1" x="58.42" y="50.8" rot="R270"/>
<instance part="R3" gate="G$1" x="68.58" y="60.96"/>
<instance part="R4" gate="G$1" x="68.58" y="50.8"/>
<instance part="R5" gate="G$1" x="-25.4" y="35.56" rot="R180"/>
<instance part="R6" gate="G$1" x="-38.1" y="35.56" rot="R180"/>
<instance part="R7" gate="G$1" x="-53.34" y="35.56" rot="R180"/>
<instance part="GND11" gate="1" x="-60.96" y="30.48"/>
<instance part="C6" gate="G$1" x="-50.8" y="45.72" rot="R270"/>
<instance part="U4" gate="G$1" x="17.78" y="53.34" rot="MR0"/>
...
<segment>
<pinref part="U2" gate="G$1" pin="!RST!/PIO0_5"/>
...
<segment>
<pinref part="U2" gate="G$1" pin="PIO0_4/WAKEUP/!TRST!"/>
...
<wire x1="35.56" y1="-22.86" x2="88.9" y2="-22.86" width="0.1524" layer="91"/>
...
<segment>
<pinref part="U2" gate="G$1" pin="SWCLK/PIO0_3/TCK"/>
...
<segment>
<pinref part="U2" gate="G$1" pin="SWDIO/PIO0_2/TMS"/>
...
<pinref part="U2" gate="G$1" pin="PIO0_1/ACMP_I2/CLKIN/TDI"/>
...
<wire x1="45.72" y1="0" x2="45.72" y2="60.96" width="0.1524" layer="91"/>
...
<pinref part="U2" gate="G$1" pin="PIO0_0/ACMP_I1/TDO"/>
